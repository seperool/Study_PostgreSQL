...
- De maneira semelhante a técnica de "sincronizar tabelas com relatório", automaticamente através de **TRIGGER**, a técnica de "sincronizar registros deletados" segue a mesma lógica.\
- Procedimentos:\
...
## Exemplo de código - Atualização automática de dados deletados através de **TRIGGER**
