...
# Aula 128 e 127 Parte 2 - Estatística com Banco de dados
...
- No **PostgreSQL** existe uma função que cálcula a *variância* (**VAR_POP**) de um campo/coluna.\
...
- No **PostgreSQL** existe uma função que cálcula o *desvio-padrão* (**STDDEV_POP**) de um campo/coluna.\
