...
```
  ...
  - Para usar caractere coringa, no caso da cláusula **WHERE** procurando por *strings*, basta usar o '%', que substitui varios caracteres. Também pode ser usado em conjunto com outros caracteres para afunilar o filtro.\
  Exemplo:\
  ...\
  **WHERE** coluna = 'B%';\
