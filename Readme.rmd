...
- **END IF** ou **END CASE** pode ser simplifica para apenas **END**.\
...
- A *expressão* de pesquisa é avaliada (uma vez) e comparada sucessivamente a cada *expressão Booleana* nas cláusulas **WHEN**.\
  - O **CASE** primeiro avalia a *expressão* e compara o resultado com cada *expressão Booleana* (*expressão_booleana_1*, *expressão_booleana_2*, ...) nas cláusulas **WHEN** sequencialmente até encontrar a correspondência.\

  - Assim que o resultado da *expressão* for igual a uma *expressão Booleana* (*expressão_booleana_1*, *expressão_booleana_2*, etc.) em uma cláusula **WHEN**, o **CASE** retorna o resultado correspondente na cláusula **THEN**.\
