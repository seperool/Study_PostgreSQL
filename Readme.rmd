...
- Com as instruções **LOOP**, **WHILE**, **FOR**, **FOREACH**, **EXIT** e **CONTINUE** podemos fazer com que sua função PL/pgSQL repita uma série de comandos.\
...
- O rótulo opcional (*label*) pode ser usado pelas instruções **EXIT** e **CONTINUE** dentro de loops aninhados para especificar a qual loop essas instruções se referem.\
