...
/* EXPORTAR DADOS EM FORMATO COLUNAR*/
...
-- VERIFICANDO OS DADOS DAS TABELAS CRIADAS
SELECT * FROM GENERO;
SELECT * FROM FILME;
SELECT * FROM LOCACAO;
...
/* CRIACAO TABELA A PARTIR DE QUERY */

-- VERIFICANDO A QUERY ANTES DE CRIAR A TABELA
SELECT
F.NOME,
G.NOME,
L.DATA,
...
-- CUIDADO COLUNAS COM MESMO NOME, PODE DAR PROBLEMA
-- USAR 'ALIAS' -> AS ...

-- CRIANDO A TABELA A PARTIR DA QUERY
...
INNER JOIN LOCACAO L
ON L.ID_FILME = F.IDFILME;
-- NA CRIACAO DA TABELA A PARTIR DE UMA QUERY,
-- NÃO PODE TER COLUNAS COM MESMO NOME,
-- USAR 'ALIAS' PARA RESOLVER ISSO.

-- VERIFICANDO TABELA REL_LOCADORA CRIADA
...
COPY REL_LOCADORA TO -- COPIA A TABELA PARA UM ARQUIVO
'/home/serigo/DB/PostgreSQL/Export_dados/REL_LOCADORA_COPY.csv' 
-- DEFININDO O CAMINHO ONDE SERÁ SALVO
DELIMITER ';' -- DEFININDO O QUE SEPARA OS DADOS
CSV HEADER; -- FORMATO E SE TEM, OU NÃO, CABEÇALHO

-- SEM PERMISSÃO DE SUPERUSUÁRIO
-- USAR NA LINHA DE COMANDO PELO TERMINAL
-- NÃO FUNCIONA NO pgAdmin 4
psql=# \copy (SELECT * FROM REL_LOCADOR) TO
'/home/serigo/DB/PostgreSQL/Export_dados/REL_LOCADORA_copy.csv'
WITH
DELIMITER ';'
CSV HEADER;

-- FORMA MANUAL pgAdmin 4