...
-- VERIFICANDO TABELA departamentos
...
-- VERIFICANDO TABELA localizacao
...
-- CONSERTANDO O PRIMEIRO REGISTRO DA TABELA funcionarios
-- ALTERANDO DATESTYLE PARA 'MDY'
-- CONFIRMANDO ALTERAÇÃO
SHOW DATESTYLE;

-- UPDATE DA DATA DE ADMISSÃO DO FUNCIONARIO 1 'KELLY'
UPDATE funcionarios SET admissao = '10/02/2009'
WHERE idFuncionario = 1;

-- INSERINDO OS OUTROS DADOS NA TABELA funcionarios
